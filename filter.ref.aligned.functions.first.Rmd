...
vcfR@fix[1:10,1:8]
vcfR@gt[1:10,1:2]
#randomly downsample SNPs in the vcf
#vcfd<-vcfR[sample(1:nrow(vcfR), 20000),]
#randomly downsamples samples in the vcf
#vcfd@gt<- vcfd@gt[,sample(colnames(vcfd@gt), 20)]
#export
#write.vcf(vcfd, "~/Desktop/aph.data/downsampled.vcf.gz")
